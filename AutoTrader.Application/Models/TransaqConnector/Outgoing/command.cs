...
namespace AutoTrader.Application.Models.TransaqConnector.Outgoing
{
    ...
    public class command
    {
        ...
        public static command CreateNewCondOrderCommand()
        {
            ...
            res.security = new command_ns.security();
            res.bymarketValue = AutoTrader.Application.Models.TransaqConnector.Outgoing.bymarket.yes;
            res.validafter = "0";
            res.validbeforeValue = AutoTrader.Application.Models.TransaqConnector.Outgoing.validbefore.till_canceled;

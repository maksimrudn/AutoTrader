...
namespace AutoTraderSDK.Model.Outgoing
{
    ...
    public class command
    {
        ...
        public static command CreateConnectionCommand(string login, string password, string server = "213.247.141.133", int port = 3900)
        {
            ...
            res.host = server;
            res.portValue = port;
            res.logsdir = Globals.GetWorkFolder();// +"\0";
            res.rqdelayValue = 100;
            res.session_timeoutValue = 25;
            res.request_timeoutValue = 10;
        ...
        public static command CreateNewCondOrderCommand()
        {
            ...
            res.security = new command_ns.security();
            res.bymarketValue = AutoTraderSDK.Model.Outgoing.bymarket.yes;
            res.validafter = "0";
            res.validbeforeValue = AutoTraderSDK.Model.Outgoing.validbefore.till_canceled;
        ...
        public static command CreateNewOrder(string clientId, boardsCode board, string seccode, buysell buysell, bymarket bymarket, double price, int volume)
        {
            ...
            if (bymarket == Model.Outgoing.bymarket.yes)
            {
                res.bymarket = "yes";
            }
            return res;

...
namespace AutoTraderSDK.Core
{
    public abstract class TXMLConnectorBase:IDisposable
    {
        ...
        public TXMLConnectorBase(string tconFile = "txmlconnector1.dll")
        {
            ...
            // шаг 1 - инициализация
            IntPtr pPath = Core.MarshalUTF8.StringToHGlobalUTF8(_logpath);
            IntPtr pResult = _initialize(pPath, _loglevel);
            if (!pResult.Equals(IntPtr.Zero))
            {
                String result = Core.MarshalUTF8.PtrToStringUTF8(pResult);
        ...
        protected String ConnectorSendCommand(String command)
        {
            ...
            IntPtr pData = Core.MarshalUTF8.StringToHGlobalUTF8(command);
        ...
        {
            bool res = true;
            String result = Core.MarshalUTF8.PtrToStringUTF8(pData);
            _freeMemory(pData);
